...
const Register = () => {
  ...
  <ul className="mt-4 space-y-2">
    <li>
      <a href="/register.user" className="block h-full rounded-lg border border-gray-700 p-4 hover:border-pink-600">
        <strong className="font-medium text-2xl text-white">Register as Costumers </strong>
    ...
    <li>
      <a href="/register.organizer" className="block h-full rounded-lg border border-gray-700 p-4 hover:border-pink-600">
        <strong className="font-medium text-2xl text-white">Register as Administration </strong>
